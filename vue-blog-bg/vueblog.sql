...
--
-- Host: 127.0.0.1    Database: vueblog
-- ------------------------------------------------------
...
CREATE TABLE `m_blog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='博客信息';
...
INSERT INTO `m_user` VALUES (1,'zhangsan',NULL,NULL,NULL,1,NULL,NULL);
...
-- Dump completed on 2021-07-05 14:18:56
